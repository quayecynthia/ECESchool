...
/**
 *Connexion à classe détail bulletin
 * @author ramzi
 */
public class DetailBulletinDAO extends DAO<DetailBulletin>{
    ...
    /**
     * Mise à jour détail bulletin
     * @param a
     * @return bulletin mis à jour
     */
    @Override
    ...
    /**
     * Trouver details bulletin
     * @param id
     * @return détails trouvés
     * @throws SQLException 
     */
    ...
    /**
     * Initialise bulletin grace à BDD
     * @param b
     * @throws SQLException  (genre execption)
     */
