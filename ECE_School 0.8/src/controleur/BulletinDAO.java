...
/**
 * Connexion au bulletin 
 * @author ramzi
 */
public class BulletinDAO extends DAO<Bulletin>{

    /*
    Pour générer exception
    */
     ...
     * @param a
     * @param id //id bulletin
     * @return si connexion avec BDD établie ou pas
     * @throws SQLException (génére exeption)
     */
    @Override
    ...
    /**
     * Création d'un trimestre
     * @param numero
     * @param debut //date début
     * @param fin //date fin
     * @param annee //année scolaire
     * @return id bulletin
     * @throws SQLException (genere execption)
     */
...
/**
 * Suppression d'un bulletin de la BDD
 * @param a
 * @return si le bulletin bien supprimé ou non
 * @throws SQLException (genere execption)
 */
    @Override
 ...
 */
    ...
    /**
     * Trouver un bulletin dans la bdd
     * @param id //id du bulletin recherché
     * @return le bulletin
     */
 ...
 * initialise un eleve
 * @param e
 * @throws SQLException (genere exeption)
 */
